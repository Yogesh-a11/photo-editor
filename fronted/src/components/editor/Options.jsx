...
const Options = ({previewImg}) => {
  ...
  const {selectedLayer, canvasOptions, setCanvasOptions,textOptions, setTextOptions} = useEditorStore();
          ...
          <div>
            ...
            <div className="editingOption">
              ...
              <div className="textColor">
                <div className="colorPreview" style={{ backgroundColor: textOptions.color}}
          ...
          <div> 
            <div className='editingOption'>
              ...
              <div className='orientations'>
                <div className={`orientation ${canvasOptions.orientation === "portrait" ? "selected" : ""}`} onClick={() => handleOrientationClick("portrait")}
              >P</div>
                <div className={`orientation ${canvasOptions.orientation === "landscape" ? "selected" : ""}`}   onClick={() => handleOrientationClick("landscape")}
              >L</div>
              </div>
            </div>
            <div className="editingOption">
              <span>Size</span>
              <div className="sizes">
                <div className={`size ${canvasOptions.size === "original" ? "selected" : ""}`} onClick={()=>handleSizeClick("original")}>Original</div>
                {canvasOptions.orientation === "portrait" ? (
                  <>
                    {portraitSizes.map(size=> (
                      <div className={`size ${canvasOptions.size === size.name ? "selected" : ""}`} key={size.name} onClick={()=>handleSizeClick(size)}>{size.name}</div>
                    ))}
                  </>
                ) : (
                <>
            ...
            <div className="editingOption">
              ...
              <div className="bgColor">
                <div className="colorPreview" style={{ backgroundColor: canvasOptions.backgroundColor}}
                onClick={() => setIsColorPickerOpen(!isColorPickerOpen)}
                >
                {isColorPickerOpen && 
                <div className="colorPicker"> 
